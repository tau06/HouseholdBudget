...
public class RowElementFactory {
	 ...
	 * @return
	 */
	public static RowElement createPayRowElement(String date,int money,String cashStorage, String category, String howToPay, String memo) {
		RowElement retval = new RowElement();
	 ...
	 * @return
	 */
	public static RowElement createIncomeRowElement(String date, int money, String cashStorage, String memo) {
		RowElement retval = new RowElement();
		retval.inputValue(ColumnName.date, date);
	 ...
	 * @return
	 */
	public static RowElement createMoveFromRowElement(String date,int money, String cashStorage, String memo) {
		RowElement retval = new RowElement();
		retval.inputValue(ColumnName.date, date);
	 ...
	 * @return
	 */
	public static RowElement createMoveToRowElement(String date,int money, String cashStorage, String memo){
		RowElement retval = new RowElement();
		retval.inputValue(ColumnName.date, date);
