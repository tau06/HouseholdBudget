...
public class InitializationForm extends Activity implements OnClickListener {
    ...
    public void onClick(View v) {
        if (account.getText().toString().equals("") || pass.getText().toString().equals("")
        ...
        if (!GoogleGateWay.getInstace().existSpreadSheet(spreadSheet.getText().toString())) {
            ...
            bDialog.setNegativeButton(getText(R.string.cancel),
    ...
    private void ShowToastMessage(String message) {
        // Looper.prepare();
        Toast.makeText(InitializationForm.this, message, Toast.LENGTH_SHORT).show();
        // Looper.loop();
    }
