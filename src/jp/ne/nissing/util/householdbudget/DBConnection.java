...
public class DBConnection extends SQLiteOpenHelper
{
	...
	/**
	 * コンストラクタ
	 * @param c 自身のアプリを示す場合は getApplicationContet()
	 * @param dbname データベースファイル名
	 * @param version データベースのバージョン番号．作成するときに指定可能５
	 */
	...
	public void onCreate(SQLiteDatabase db) {
		...
		try{
			...
			SQLiteStatement stmt = db.compileStatement("INSERT INTO cash_storage VALUES(?, ?,'true');");
		...
		try{
			...
			SQLiteStatement stmt = db.compileStatement("INSERT INTO paymethod VALUES(?, ?, ?, 'true');");
		...
		db.beginTransaction();
		try{
			String[] categorys = new String[]{"食費", "交通費", "交際費", "被服費", "医療費", "通信費", "税金", "住居費", "電気代", "水道代", "ガス代"};
			SQLiteStatement stmt = db.compileStatement("INSERT INTO category VALUES(?, ?, '0', 'true');");
